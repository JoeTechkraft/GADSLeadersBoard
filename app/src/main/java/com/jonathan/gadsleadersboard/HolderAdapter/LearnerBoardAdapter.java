package com.jonathan.gadsleadersboard.HolderAdapter;
...
public class LearnerBoardAdapter extends RecyclerView.Adapter<LearnerBoardAdapter.LeanerBoardViewHolder> {

    ArrayList<Learners> mArrayList;
    ImageView mImageView;
    public LearnerBoardAdapter(ArrayList<Learners> learners) {
